...
LINKEDIN_EMAIL = "danushidk507@gmail.com"
LINKEDIN_PASSWORD = ""
def get_client():
    return Linkedin(LINKEDIN_EMAIL, LINKEDIN_PASSWORD, debug=True)
dir(mcp)
@mcp.tool()
...
if __name__ == "__main__":
    import sys
    result = search_jobs(keywords="data scientist", location="chennai", limit=2)
